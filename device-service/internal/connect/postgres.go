...
// device-service depends on: PostgreSQL (appdb), TimescaleDB (metricsdb),
// and Redis. Internal Docker hostnames and ports are hardcoded — env var
// ports are host-machine mappings only and never used inside Docker.
package connect
